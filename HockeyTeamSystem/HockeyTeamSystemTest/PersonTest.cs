...
namespace HockeyTeamSystemTest
{
    ...
    public class PersonTest
    {
        ...
        [DataRow("")]
        [DataRow("      \n\t")]
        public void FullName_InvalidNoName_ThrowsException(string fullname)
        {
        ...
        [DataRow("AB")]
        [DataRow("A B")]
        //[DataRow("AB CD")] Valid data if you test it it will fail the test 
        public void FullName_InvalidNameLength_ThrowsException(string fullname)
        {
